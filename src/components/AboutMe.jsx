    ...
    return (
        <section id="about" className="about animated-bg" onDoubleClick={changeBackground}>
            ...
            <div className="about-content">
                <img src="./aman_semi_formal.jpeg" alt="Aman Kumar Yadav" className="profile-img" />
                ...
                <div className="resume-container">
                    <a href="https://drive.google.com/file/d/1sILtEFmWzGQB88Z5CYH5rhe1Au9CbQ4I/view?usp=sharing"
                        className="btn"
                        download>
                        📄 Download My Resume
                    </a>
